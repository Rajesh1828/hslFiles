...
const Footer = () => {
  return (
    <footer class="relative w-full py-5 bg-gray-200">
      <div class="w-full px-8 mx-auto max-w-7xl">
        <div class="grid justify-between grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="grid justify-between grid-cols-3 gap-4">
            ...
            <p class="block mb-1 text-sm font-semibold text-slate-800">About</p>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio nemo vel molestias alias esse voluptatibus!</p>
            </div>
        ...
        <div class="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-slate-200 md:flex-row md:justify-between">
          <p class="block mb-4 text-sm text-center text-slate-600 md:mb-0">
          <hr />
