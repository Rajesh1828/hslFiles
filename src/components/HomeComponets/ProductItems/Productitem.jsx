...
const Productitem = ({ id, name, images }) => {
    ...
    return (
        <div className=' rounded-2xl px-5 py-4 animation-fadeIn' >
            <Link to={`/product/${id}`}>
                <div>
                    <img src={images} alt="" className=' w-[300px] border-1  h-[300px] bg-gray-50 p-2 hover:shadow-2xl shadow-gray-950  transition duration-500 ease-in-out hover:scale-103 rounded-2xl' />
